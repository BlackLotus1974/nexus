  ...
  public: {
    Tables: {
      ...
      donor_project_alignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "donor_project_alignments_donor_id_fkey"
            columns: ["donor_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "donor_project_alignments_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
      ...
      relationships: {
        ...
        Relationships: [
          {
            foreignKeyName: "relationships_donor_id_fkey"
            columns: ["donor_id"]
            isOneToOne: false
            referencedRelation: "donors"
            referencedColumns: ["id"]
